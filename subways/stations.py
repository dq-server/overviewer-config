subwayStations = {
	...
	"Creeper Station": { "x": 289, "z": -105, "color": "red" },
	"Inner Yard": { "x": 178, "z": -20, "color": "red" },
	"Manyak's House": { "x": 178, "z": -85, "color": "red" },
	"Pankiss": { "x": 108, "z": -15, "color": "red" },
	"Respawn Castle": { "x": 110, "z": -87, "color": "red" },
	"Supercomputer": { "x": 289, "z": -3, "color": "red" },
	"Titans' Hall (red)": { "x": 178, "z": 61, "color": "red" },

	"Lava Columns": { "x": 203, "z": 48, "color": "cyan" },
	"Old Catacombs": { "x": 281, "z": 48, "color": "cyan" },
